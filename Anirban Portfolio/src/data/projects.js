...
export const PROJECTS = [
    {
        ...
        slug: 'baymax-ai',
        image: `${BASE}7.webp`,
        thumb: `${BASE}7-sm.webp`,
        gallery: [`${BASE}2.4.webp`, `${BASE}2.3.webp`, `${BASE}2.2.webp`],
        galleryThumbs: [`${BASE}2.4-sm.webp`, `${BASE}2.3-sm.webp`, `${BASE}2.2-sm.webp`],
        title: 'Baymax AI',
    ...
    },
    {
        ...
        slug: 'google-summit',
        image: `${BASE}2.webp`,
        thumb: `${BASE}2-sm.webp`,
        gallery: [`${BASE}5.2.webp`, `${BASE}5.1.webp`, `${BASE}5.3.webp`],
        galleryThumbs: [`${BASE}5.2-sm.webp`, `${BASE}5.1-sm.webp`, `${BASE}5.3-sm.webp`],
        title: 'GSC Summit',
    ...
    },
    {
        ...
        slug: 'karukarjo-erp',
        image: `${BASE}6.webp`,
        thumb: `${BASE}6-sm.webp`,
        gallery: [`${BASE}6.2.webp`, `${BASE}6.1.webp`, `${BASE}6.3.webp`],
        galleryThumbs: [`${BASE}6.2-sm.webp`, `${BASE}6.1-sm.webp`, `${BASE}6.3-sm.webp`],
        title: 'Karukarjo ERP',
    ...
    },
    {
        ...
        slug: 'vision-ai',
        image: `${BASE}5.webp`,
        thumb: `${BASE}5-sm.webp`,
        gallery: [`${BASE}3.1.webp`, `${BASE}3.2.webp`, `${BASE}3.3.webp`],
        galleryThumbs: [`${BASE}3.1-sm.webp`, `${BASE}3.2-sm.webp`, `${BASE}3.3-sm.webp`],
        title: 'Vision AI',
    ...
    },
    {
        ...
        slug: 'robotics-lab',
        image: `${BASE}1.webp`,
        thumb: `${BASE}1-sm.webp`,
        gallery: [`${BASE}10.1.webp`, `${BASE}10.2.webp`, `${BASE}10.3.webp`],
        galleryThumbs: [`${BASE}10.1-sm.webp`, `${BASE}10.2-sm.webp`, `${BASE}10.3-sm.webp`],
        title: 'Robotics Lab',
    ...
    },
    {
        ...
        slug: 'kali-webos',
        image: `${BASE}3.webp`,
        thumb: `${BASE}3-sm.webp`,
        gallery: [`${BASE}9.1.webp`, `${BASE}9.2.webp`, `${BASE}9.3.webp`],
        galleryThumbs: [`${BASE}9.1-sm.webp`, `${BASE}9.2-sm.webp`, `${BASE}9.3-sm.webp`],
        title: 'Kali WebOS',
    ...
    },
    {
        ...
        slug: 'eco-pod',
        image: `${BASE}4.webp`,
        thumb: `${BASE}4-sm.webp`,
        gallery: [`${BASE}4.1.webp`, `${BASE}4.2.webp`, `${BASE}4.3.webp`],
        galleryThumbs: [`${BASE}4.1-sm.webp`, `${BASE}4.2-sm.webp`, `${BASE}4.3-sm.webp`],
        title: 'ECO Pod',
    ...
    },
    {
        ...
        slug: 'modern-ui-ux',
        image: `${BASE}8.webp`,
        thumb: `${BASE}8-sm.webp`,
        gallery: [`${BASE}11.1.webp`, `${BASE}11.2.webp`, `${BASE}11.3.webp`],
        galleryThumbs: [`${BASE}11.1-sm.webp`, `${BASE}11.2-sm.webp`, `${BASE}11.3-sm.webp`],
        title: 'UI/UX Systems',
